...
consul_version=("1.9.0" "1.8.3" "1.8.2" "1.8.1" "1.8.0" "1.7.4" "1.7.3" "1.7.2")
envoy_version=("1.16.0" "1.15.0" "1.14.4" "1.14.2" "1.13.4" "1.13.2" "1.13.1" "1.12.6" "1.12.4" "1.12.3" "1.11.2" "1.10.0")
